...
export default function PostButtons({ likesCount:likesCountdefault= 0, likedByMe:likedByMeDefault=false, id,likedByMe  }) {
    ...
    return (
        <div className="flex justify-between mr-12 text-twitterLightGray text-sm mt-1">
            ...
            <button className={(likeByMe ? 'text-red-500 fill-red-500 ' : '') +"flex items-center"} onClick={toggleLike}>
